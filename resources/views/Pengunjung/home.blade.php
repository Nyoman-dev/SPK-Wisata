    ...
    <section class="bg-[#282626] relative overflow-hidden pt-20">
      <div class="max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-0">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          ...
          <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Kami berfokus pada dunia teknologi dan inovasi, di mana teknologi, inovasi membuka nilai jangka panjang dan mendorong pertumbuhan parawisata.</p>
        </div>
